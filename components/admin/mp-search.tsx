    ...
    <div className="space-y-4">
      <div
        className={cn(
          "grid gap-3",
          variant === "desktop"
            ? "grid-cols-1 sm:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)_minmax(0,1fr)_auto] items-end"
            : "grid-cols-1"
        )}
      >
        <div className="flex flex-col gap-2">
          ...
          <Input
            ...
            className={cn(
              "w-full",
              variant === "desktop" ? "sm:max-w-xs" : undefined
            )}
          />
        </div>
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <select
            ...
            value={filters.scope}
            onChange={(event) =>
              handleChange("scope", event.target.value as MpSearchScope)
            }
          >
  ...
  if (variant === "mobile") {
    return (
      <Card className={className}>
        <CardHeader>
          <CardTitle>MercadoPago - Búsqueda MP</CardTitle>
        </CardHeader>
  ...
  return (
    <section className={cn("rounded-xl border bg-background shadow-sm", className)}>
      <div className="border-b px-6 py-5">
        <h2 className="text-xl font-semibold">MercadoPago - Búsqueda MP</h2>
        <p className="text-sm text-muted-foreground">
