...
/**
 * Animated Cannafriend logo that fills with color
 * Uses CSS animation to create a loading effect
 */
export function AnimatedLogo({
  ...
  return (
    <svg
      ...
      height={dim}
      role="img"
      aria-label="Cannafriend loading"
      className={cn("inline-block", className)}
      style={style}
      {...props}
    >
      <defs>
        {/* Gradient that moves from bottom to top */}
